...
Topic: Iteration – For…Next Loops

A For…Next loop is used when the number of repetitions is known in advance.
...
When not to use a For…Next loop:
...
Typical uses of a For…Next loop:
